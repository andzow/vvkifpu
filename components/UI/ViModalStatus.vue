<template>
  <div class="modalInfo" :class="{ modalInfo_actice: useStatus !== null }">
      ...
      <div class="modalInfo__border" v-if="useStatus == 200">
        <div class="modalInfo__card">
          <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20.3994 34.5293L30.0162 44.1461L49.2499 24.9125" stroke="#542fe6" stroke-width="4"
              stroke-linecap="round" />
            <circle cx="34" cy="34" r="32" stroke="#542fe6" stroke-width="4" />
          </svg>
        ...
        <div class="modalInfo__card">
          <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              ...
              stroke="#542fe6" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
    ...
    <Transition>
      <div class="modalInfo__border" v-if="useStatus == 214">
        <div class="modalInfo__card">
          <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20.3994 34.5293L30.0162 44.1461L49.2499 24.9125" stroke="#542fe6" stroke-width="4"
              stroke-linecap="round" />
          ...
          <h3 class="modalInfo__title">Новость успешно удалена</h3>
          <p class="modalInfo__description">
            Мы рады сообщить, что вы успешно удалили новость.
          </p>
          <NuxtLink class="modalInfo__btn" @click="useStatus = null">Продолжить</NuxtLink>
        </div>
      </div>
    ...
    <Transition>
      <div class="modalInfo__border" v-if="useStatus == 215">
        <div class="modalInfo__card">
          <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20.3994 34.5293L30.0162 44.1461L49.2499 24.9125" stroke="#542fe6" stroke-width="4"
              stroke-linecap="round" />
          ...
          <h3 class="modalInfo__title">Новость успешно изменина</h3>
          <p class="modalInfo__description">
            Мы рады сообщить, что вы успешно изменили новость.
          </p>
          <NuxtLink class="modalInfo__btn" @click="useStatus = null">Продолжить</NuxtLink>
        </div>
      </div>
    ...
    <Transition>
      <div class="modalInfo__border" v-if="useStatus == 400">
        <div class="modalInfo__card">
          <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="34" cy="34" r="32" stroke="#542fe6" stroke-width="4" />
            <rect x="44.11" y="22" width="4" height="31.2682" rx="2" transform="rotate(45 44.11 22)" fill="#542fe6" />
            <rect x="22" y="24.8281" width="4" height="31.2682" rx="2" transform="rotate(-45 22 24.8281)"
              fill="#542fe6" />
          </svg>
          <h3 class="modalInfo__title">Пустое поле</h3>
          <p class="modalInfo__description">
            Пожалуйста убедитесь, что вы не оставили пустых полей в форме создания
          </p>
    ...
    <Transition>
      <div class="modalInfo__border" v-if="useStatus == 409">
        <div class="modalInfo__card">
          <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="34" cy="34" r="32" stroke="#542fe6" stroke-width="4" />
            <rect x="44.11" y="22" width="4" height="31.2682" rx="2" transform="rotate(45 44.11 22)" fill="#542fe6" />
          ...
          <h3 class="modalInfo__title">Повторяющее название</h3>
          <p class="modalInfo__description">
            Пожалуйста убедитесь, что вы не используете повторяющих названий
          </p>
          <button class="modalInfo__btn" @click="offActive">Повторить попытку</button>
        </div>
      </div>
